...
export const StockbarItem = ({ to, Icon, label, iconSize, padding, isTrendingStock }) => {
  return (
    <div className="w-full">
      <Link
        to={to}
        className={`w-80 flex flex-row justify-center items-center border border-zinc-800  bg-zinc-950 hover:bg-zinc-900 shadow-2xl transition duration-300 ease-in-out ${padding}`}
      >
